...
uint8_t active_dimmer_states[NUM_ACTIVE_STEPS][NUM_DIMMERS] = {
  {LIGHTPREP_ON, LIGHTPREP_OFF },
  {LIGHTPREP_ON, LIGHTPREP_OFF },
  {LIGHTPREP_OFF, LIGHTPREP_ON },
  {LIGHTPREP_OFF, LIGHTPREP_ON},

};

Step active_steps[NUM_ACTIVE_STEPS] = { 
      { 0, 1, duration, 14000, MOTOR_ON, DIMM_CYCLE_SHORT_MS, 0,
            { 
              { DIMM_LEVEL_OFF, DIMM_LEVEL_OFF, DIMM_LEVEL_HIGH, DIMM_DOWN, NOT_OSCELLATING },
              { DIMM_LEVEL_HIGH, DIMM_LEVEL_LOWEST, DIMM_LEVEL_HIGH, DIMM_UP, IS_OSCELLATING },
              },
        },
      { 1, 2, duration, 14000, MOTOR_ON, DIMM_CYCLE_SHORT_MS, 0,
            {
              { DIMM_LEVEL_OFF, DIMM_LEVEL_OFF, DIMM_LEVEL_HIGH, DIMM_DOWN, NOT_OSCELLATING },
              { DIMM_LEVEL_HIGH, DIMM_LEVEL_LOWEST, DIMM_LEVEL_HIGH, DIMM_UP, IS_OSCELLATING },
              },
        },
      { 2, 3, duration, 14000, MOTOR_ON, DIMM_CYCLE_SHORT_MS, 0, 
            {
              { DIMM_LEVEL_OFF, DIMM_LEVEL_OFF, DIMM_LEVEL_HIGH, DIMM_DOWN, NOT_OSCELLATING },
              { DIMM_LEVEL_HIGH, DIMM_LEVEL_LOWEST, DIMM_LEVEL_HIGH, DIMM_UP, IS_OSCELLATING },
              },
        },
      { 3, 0, duration, 14000, MOTOR_ON, DIMM_CYCLE_SHORT_MS, 0,
            { 
              { DIMM_LEVEL_OFF, DIMM_LEVEL_OFF, DIMM_LEVEL_HIGH, DIMM_DOWN, NOT_OSCELLATING },
              { DIMM_LEVEL_HIGH, DIMM_LEVEL_LOWEST, DIMM_LEVEL_HIGH, DIMM_UP, IS_OSCELLATING },
              },
...
Step inactive_steps[NUM_INACTIVE_STEPS] = { 
      { 0, 1, on_off, 0, MOTOR_OFF, DIMM_CYCLE_LONG_MS, 0,
            { 
              { DIMM_LEVEL_OFF, DIMM_LEVEL_OFF, DIMM_LEVEL_OFF, DIMM_DOWN, NOT_OSCELLATING },
              { DIMM_LEVEL_LOW, DIMM_LEVEL_LOW, DIMM_LEVEL_HIGH, DIMM_UP, IS_OSCELLATING },
              }
        }
      };
