...
// 1 or more position pins
#define NUM_POSITION_PINS 1
uint8_t position_pin_list[NUM_POSITION_PINS] = { A0, };
uint8_t position_index_list[NUM_POSITION_PINS] = { 5, };
...
#define NUM_LIGHT_LEVELS 2
#define LIGHTPREP_OFF 0
#define LIGHTPREP_ON 1


#define NUM_INTERRUPTS_0 0
#define NUM_INTERRUPTS_1 1
#define NUM_INTERRUPTS_2 2
#define NUM_INTERRUPTS_3 3
#define NUM_INTERRUPTS_4 4
...
uint32_t  print_every_ms=86000000;     // loggin should print messages after this many milliseconds
