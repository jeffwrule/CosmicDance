...
void setup() {
  ...
  d1_dance_moves[i++] =
    new DanceMove(
          "LCU2",
          86,                        // move_delay_seconds     seconds to delay before we start moving the motor
          SITX2_MOVE_UP,            // move_direction         motor direction l,r (l=down, r=up typically)
          SITX2_SPEED_UP,           // move_speed             pwm speed to run the motor at, 0-255
          SITX2_LONG_MOVE_DURATION, // move_duration_seconds  5 minutes, we just want to hit the limit to stop
          DELAY_TYPE_DANCE          // delay start DANCE 'd' or MOVE 'm'
  ...
  d1_dance_moves[i++] =
    new DanceMove(
          "LCU3",
          155,                        // move_delay_seconds     seconds to delay before we start moving the motor
          SITX2_MOVE_UP,            // move_direction         motor direction l,r (l=down, r=up typically)
          SITX2_SPEED_UP,           // move_speed             pwm speed to run the motor at, 0-255
          SITX2_LONG_MOVE_DURATION, // move_duration_seconds  5 minutes, we just want to hit the limit to stop
          DELAY_TYPE_DANCE          // delay start DANCE 'd' or MOVE 'm'
  ...
  d1_dance_moves[i++] =
    new DanceMove(
          "LCD3",
          101,                        // move_delay_seconds     seconds to delay before we start moving the motor
          SITX2_MOVE_DOWN,            // move_direction         motor direction l,r (l=down, r=up typically)
          SITX2_SPEED_UP,           // move_speed             pwm speed to run the motor at, 0-255
          SITX2_LONG_MOVE_DURATION, // move_duration_seconds  5 minutes, we just want to hit the limit to stop
          DELAY_TYPE_DANCE          // delay start DANCE 'd' or MOVE 'm'
  ...
  d1_dance_moves[i++] =
    new DanceMove(
          "LCU4",
          216,                        // move_delay_seconds     seconds to delay before we start moving the motor
          SITX2_MOVE_UP,            // move_direction         motor direction l,r (l=down, r=up typically)
          SITX2_SPEED_UP,           // move_speed             pwm speed to run the motor at, 0-255
          SITX2_LONG_MOVE_DURATION, // move_duration_seconds  5 minutes, we just want to hit the limit to stop
          DELAY_TYPE_DANCE          // delay start DANCE 'd' or MOVE 'm'
  ...
  d2_dance_moves[i++] = new DanceMove(
        "RCU1",
        56,                       // move_delay_seconds     seconds to delay before we start moving the motor
        SITX2_MOVE_UP,            // move_direction         motor direction l,r (l=down, r=up typically)
        SITX2_SPEED_UP,           // move_speed             pwm speed to run the motor at, 0-255
        SITX2_LONG_MOVE_DURATION, // move_duration_seconds  5 minutes, we just want to hit the limit to stop
        DELAY_TYPE_DANCE          // delay start DANCE 'd' or MOVE 'm' 
  ...
  d2_dance_moves[i++] = new DanceMove(
        "RCU2",
        128,                      // move_delay_seconds     seconds to delay before we start moving the motor
        SITX2_MOVE_UP,            // move_direction         motor direction l,r (l=down, r=up typically)
        SITX2_SPEED_UP,           // move_speed             pwm speed to run the motor at, 0-255
        SITX2_LONG_MOVE_DURATION, // move_duration_seconds  5 minutes, we just want to hit the limit to stop
        DELAY_TYPE_DANCE          // delay start DANCE 'd' or MOVE 'm' 
  ...
  d2_dance_moves[i++] = new DanceMove(
        "RCU4",
        240,                      // move_delay_seconds     seconds to delay before we start moving the motor
        SITX2_MOVE_UP,            // move_direction         motor direction l,r (l=down, r=up typically)
        SITX2_SPEED_UP,           // move_speed             pwm speed to run the motor at, 0-255
        SITX2_LONG_MOVE_DURATION, // move_duration_seconds  5 minutes, we just want to hit the limit to stop
        DELAY_TYPE_DANCE          // delay start DANCE 'd' or MOVE 'm' 
