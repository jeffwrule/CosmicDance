...
class Dancer {
  ...
  public:
    ...
    // p_dancer_pin   input from primary dancer remote_is_dancing, INPUT 
    //                    NOTE: input pin can/should be tied to ground with 10K resistor to help with false starts during start, or reboot of the primary
