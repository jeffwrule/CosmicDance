...
//	int millis_delay = 60L * 1000L /number_of_steps/(stepperMotor.speed + 50);
	int millis_delay = 11L * 1000L /number_of_steps/(stepperMotor.speed + 50);
	if (steps > 0) 
	{
...
//        Serial.print(last_step);
//        Serial.print(" diff: ");
//        Serial.print(cur_time - last_step);
//        Serial.print('\n');
        
        if (last_step == 0 || cur_time - last_step >= delay_ms)
        {
