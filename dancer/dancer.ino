...
#define VARY_MIN_SPEED 28L    // string ripple 
...
#define VARY_SECONDS 19L       // number of seconds between min and max
#define VARY_SECONDS_INIT 6L  // number of seconds to vary the init value down/up to min/max
