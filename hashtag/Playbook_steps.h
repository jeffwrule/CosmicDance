...
#define NUM_ACTIVE_STEPS 4
uint8_t active_dimmer_states[NUM_ACTIVE_STEPS][NUM_DIMMERS] = {
  {LIGHTPREP_OFF, LIGHTPREP_ON, LIGHTPREP_OFF, LIGHTPREP_ON, LIGHTPREP_OFF, LIGHTPREP_ON},
  {LIGHTPREP_ON, LIGHTPREP_ON, LIGHTPREP_OFF, LIGHTPREP_OFF, LIGHTPREP_OFF, LIGHTPREP_OFF},
  {LIGHTPREP_OFF, LIGHTPREP_ON, LIGHTPREP_OFF, LIGHTPREP_ON, LIGHTPREP_OFF, LIGHTPREP_ON},
  {LIGHTPREP_OFF, LIGHTPREP_OFF, LIGHTPREP_ON, LIGHTPREP_ON, LIGHTPREP_OFF, LIGHTPREP_OFF}
};

Step active_steps[NUM_ACTIVE_STEPS] = { 
      { 0, 1, position, 0, true, DIMM_CYCLE_ULTRA_SHORT_MS,  
            { 
      ...
      { 1, 2, duration, 20000, false, DIMM_CYCLE_ULTRA_SHORT_MS, 
            {
              { DIMM_LEVEL_OFF, DIMM_LEVEL_OFF, DIMM_LEVEL_HIGH, DIMM_DOWN, NOT_OSCELLATING },
              { DIMM_LEVEL_HIGH, DIMM_LEVEL_LOW, DIMM_LEVEL_HIGH, DIMM_UP, IS_OSCELLATING },
              },
        },
      { 2, 3, position, 0, true, DIMM_CYCLE_ULTRA_SHORT_MS,  
            {
              { DIMM_LEVEL_OFF, DIMM_LEVEL_OFF, DIMM_LEVEL_HIGH, DIMM_DOWN, NOT_OSCELLATING },
              { DIMM_LEVEL_HIGH, DIMM_LEVEL_LOW, DIMM_LEVEL_HIGH, DIMM_UP, IS_OSCELLATING },
              },
        },
      { 3, 0, duration, 20000, false, DIMM_CYCLE_ULTRA_SHORT_MS, 
            { 
              { DIMM_LEVEL_OFF, DIMM_LEVEL_OFF, DIMM_LEVEL_HIGH, DIMM_DOWN, NOT_OSCELLATING },
              { DIMM_LEVEL_HIGH, DIMM_LEVEL_LOW, DIMM_LEVEL_HIGH, DIMM_UP, IS_OSCELLATING },
              },
...
uint8_t inactive_dimmer_states[NUM_INACTIVE_STEPS][NUM_DIMMERS] = {
  {LIGHTPREP_OFF, LIGHTPREP_OFF, LIGHTPREP_OFF, LIGHTPREP_OFF, LIGHTPREP_OFF, LIGHTPREP_OFF},
  {LIGHTPREP_OFF, LIGHTPREP_ON, LIGHTPREP_OFF, LIGHTPREP_ON, LIGHTPREP_OFF, LIGHTPREP_ON},
};

Step inactive_steps[NUM_INACTIVE_STEPS] = { 
      { 0, 1, position, 0, true, DIMM_CYCLE_SHORT_MS,  
            { 
    ...
    { 1, 1,  on_off, 0, false, DIMM_CYCLE_SHORT_MS,  
            { 
              { DIMM_LEVEL_OFF, DIMM_LEVEL_OFF, DIMM_LEVEL_OFF, DIMM_DOWN, NOT_OSCELLATING },
              { DIMM_LEVEL_MEDIUM, DIMM_LEVEL_LOW, DIMM_LEVEL_MEDIUM, DIMM_UP, IS_OSCELLATING },
              },
