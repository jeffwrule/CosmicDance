...
#define HOLD_COLOR_MS 30000

#define NUM_COLORS 4
CRGB colors[NUM_COLORS] = {CRGB::HotPink, CRGB::MediumVioletRed, CRGB::Purple, CRGB::DarkSlateBlue};
const char *color_names[NUM_COLORS] = { "HotPink", "MediumVioletRed", "Purple", "DarkSlateBlue" };
const uint8_t color_brightness[NUM_COLORS] = { 120, 120, 120, 120 };
