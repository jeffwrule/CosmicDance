...
#define REVERSE_DELAY  1000      // normal
...
#define RIGHT_LIMIT_TYPE 'b'   // d for digital switch 'a' for analog ACS712 module, b (both) single sensor for both right and left 
...
// longing cloud  updated to 5 seconds to handle saggy fabric. 
#define DANCER_EXTEND_SECONDS 5  
//Heaven and Earth
