...
#define STOP_DELAY         100    // milliseconds to delay between decrements in speed when stopping, typical setting, heaven n earth
...
#define REVERSE_DELAY  3000      // milleseconds to delay when reversing... new setting for heaven and earth
